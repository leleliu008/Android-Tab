...
public abstract class TabActivity<T> extends BaseActivity implements IndicatorViewPager.OnIndicatorPageChangeListener, List<T> {
    ...
    public void setIndicator(Indicator indicator) {
        ...
        indicatorViewPager.setAdapter(adapter = new IndicatorViewPager.IndicatorFragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public View getViewForTab(int position, View convertView, ViewGroup container) {
                return TabActivity.this.getViewForTab(position, convertView, container, get(position));
            }
    ...
    public void setColorScrollBar(int color, int height) {
        indicatorView.setScrollBar((new ColorBar(this, color, height)));
    }

    public void setColorScrollBar(int color, int height, ScrollBar.Gravity gravity) {
        indicatorView.setScrollBar((new ColorBar(this, color, height, gravity)));
    }

    public void setColorResScrollBar(int colorId, int height) {
        indicatorView.setScrollBar((new ColorBar(this, getResources().getColor(colorId), height)));
    }

    public void setColorResScrollBar(int colorId, int height, ScrollBar.Gravity gravity) {
        indicatorView.setScrollBar((new ColorBar(this, getResources().getColor(colorId), height, gravity)));
    }
